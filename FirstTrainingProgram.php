...
<body>
    ...
    <main>
        <div class="FirstProgram">
            ...
            <div id="product" class="program-description">
              <h1>Push/Pull/Legs Hypertrophy Program</h1>
              ...
              <div class="star">
                <span id="stars">&starf;&starf;&starf;&starf;&starf; <p id="reviews">75 reviews</p></span>
              </div>
              <p style="width: 35%;">Intermediate-Advanced</p>
              <h2>$39.99</h2>
              <hr width="90%"/>
